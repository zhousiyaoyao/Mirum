...
Page({
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (list == null) {
          ...
          that.setData({
            spot_list: list.slice(8, 10),
            imgUrls: imgUrls.slice(8, 10),
            spot_ID: ID.slice(8, 10),
            title: list[8].spotName
          });
        }
      }
    })
  ...
  daohang: function (e) {
    ...
    console.log(that.getSchoolMarkers()[id - 9])
    wx.openLocation({
      latitude: that.getSchoolMarkers()[id - 9].latitude,
      longitude: that.getSchoolMarkers()[id - 9].latitude,
    })
  },
})