...
Page({
  ...
  bindchange: function(e){
    ...
    console.log(that.getSchoolMarkers()[page])
    ...
    wx.request({
      ...
      success: function (res) {
        ...
        if (list == null) {
          ...
          that.setData({
            spot_list: list.slice(0,5),
            spot_imgUrls: imgUrls.slice(0,5),
            spot_ID: ID.slice(0,5),
            shopping_list: list.slice(5,8),
            shopping_imgUrls: imgUrls.slice(5,8),
            shopping_ID: imgUrls.slice(5,8),
  ...
  daohang: function (e) {
    ...
    console.log(that.getSchoolMarkers()[id-1])
    wx.openLocation({
      latitude: that.getSchoolMarkers()[id - 1].latitude,
      longitude: that.getSchoolMarkers()[id - 1].latitude,
    })
  },
})